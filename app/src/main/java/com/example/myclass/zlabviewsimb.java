...
public class zlabviewsimb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabviewsimb);
    ...
    public void znexta(View view){
        Intent intent = new Intent(this,zlabviewsimc.class);
