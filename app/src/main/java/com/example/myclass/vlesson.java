...
public class vlesson extends AppCompatActivity {
    ...
    String st,st0,st1,st2,st3,st4,st5,st6,st16,st17,st18,st20,stn,said,sbid;
    ...
    public void addvless(View view){
        ...
        Intent intent = new Intent(getApplicationContext(),addvlesson.class);
        intent.putExtra("uname", stn);
        intent.putExtra("value",st);
        intent.putExtra("gid",st1);
        intent.putExtra("sidname",st2);
    ...
    public void dcsub(View view){
        AlertDialog.Builder builder =  new AlertDialog.Builder(vlesson.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                RequestQueue queue = Volley.newRequestQueue(vlesson.this);
                ...
                JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                        ...
                        new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                Toast.makeText(vlesson.this, "Delete Subject", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(vlesson.this,subject.class);
                                intent.putExtra("uname", stn);
                                intent.putExtra("value",st);
                                intent.putExtra("gid",st1);
                                intent.putExtra("aid",said);
