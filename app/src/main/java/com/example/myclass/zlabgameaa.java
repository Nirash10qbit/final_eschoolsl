...
public class zlabgameaa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabgameaa);
    ...
    public void zbackza(View view){
        Intent intent = new Intent(this,gameza.class);
    ...
    public void loadSession1(){
        ...
        JsonObjectRequest jsonObjectRequest4 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/answer.php?cid="+st5+"", null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            tvaa.setText(response.getString("aaa"));
        ...
        VolleySingleton.getInstance(zlabgameaa.this).addToRequestQueue(jsonObjectRequest4);
    }
}