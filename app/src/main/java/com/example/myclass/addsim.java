...
public class addsim extends AppCompatActivity {
    ...
    String etsim,etaa,etab,etac,etad,etae,st,st0,st1,st2,st3,st4,st5,st6,st16,st20,st30,st31,
            stn,said,sbid,szid,etqa,etqb,etqc,etqd,etqe,asub,aact,encodeImageString,encodeImageString1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1 = findViewById(R.id.sub);
        asub = getIntent().getExtras().getString("asub");
        tv1.setText(asub);

        tv2 = findViewById(R.id.act);
        ...
        etadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String gana = "A) " + etgana.getText().toString();
                String bna = etbna.getText().toString();
                String gbna = "A) " + etgbna.getText().toString();
                String cna = etcna.getText().toString();
                String gcna = "A) " + etgcna.getText().toString();
                String dna = etdna.getText().toString();
                String gdna = "A) " + etgdna.getText().toString();
                String ena = etena.getText().toString();
                String gena = "A) " + etgena.getText().toString();

                String anb = etanb.getText().toString();
                String ganb = "B) " + etganb.getText().toString();
                String bnb = etbnb.getText().toString();
                String gbnb = "B) " + etgbnb.getText().toString();
                String cnb = etcnb.getText().toString();
                String gcnb = "B) " + etgcnb.getText().toString();
                String dnb = etdnb.getText().toString();
                String gdnb = "B) " + etgdnb.getText().toString();
                String enb = etenb.getText().toString();
                String genb = "B) " + etgenb.getText().toString();

                String anc = etanc.getText().toString();
                String ganc = "C) " + etganc.getText().toString();
                String bnc = etbnc.getText().toString();
                String gbnc = "C) " + etgbnc.getText().toString();
                String cnc = etcnc.getText().toString();
                String gcnc = "C) " + etgcnc.getText().toString();
                String dnc = etdnc.getText().toString();
                String gdnc = "C) " + etgdnc.getText().toString();
                String enc = etenc.getText().toString();
                String genc = "C) " + etgenc.getText().toString();

                String and = etand.getText().toString();
                String gand = "D) " + etgand.getText().toString();
                String bnd = etbnd.getText().toString();
                String gbnd = "D) " + etgbnd.getText().toString();
                String cnd = etcnd.getText().toString();
                String gcnd = "D) " + etgcnd.getText().toString();
                String dnd = etdnd.getText().toString();
                String gdnd = "D) " + etgdnd.getText().toString();
                String end = etend.getText().toString();
                String gend = "D) " + etgend.getText().toString();
        ...
        browse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dexter.withActivity(addsim.this)
    ...
    private void addclasses( final String aasub, final String aaact,final String gid, final String sid, final String cid, final String aid, final String bid, final String zid, final String nna,final String sub1, final String sub2, final String sub3, final String sub4, final String sub5, final String sub6, final String sub7,final String cidname, final String sim, final String qa, final String qb, final String qc, final String qd, final String qe, final String aa, final String ab, final String ac, final String ad, final String ae,final String ca, final String ana,  final String gana, final String bna, final String gbna, final String cna, final String gcna, final String dna, final String gdna, final String ena, final String gena,final String cb, final String anb,  final String ganb, final String bnb, final String gbnb, final String cnb, final String gcnb, final String dnb, final String gdnb, final String enb, final String genb,final String cc, final String anc,  final String ganc, final String bnc, final String gbnc, final String cnc, final String gcnc, final String dnc, final String gdnc, final String enc, final String genc,final String cd, final String and,  final String gand, final String bnd, final String gbnd, final String cnd, final String gcnd, final String dnd, final String gdnd, final String end, final String gend) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Endspoint.addsim_url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {

                if (response.equals("success")) {
                    Toast.makeText(addsim.this,"Successfully Access data", Toast.LENGTH_SHORT).show();
                    progressBaradd.setVisibility(View.VISIBLE);
                    Intent intent = new Intent(addsim.this,plesson.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(addsim.this, "Please check your Internet Connection",Toast.LENGTH_SHORT).show();
                Log.d("VOLLEY", error.getMessage());
                progressBaradd.setVisibility(View.VISIBLE);
                Intent intent = new Intent(addsim.this,addsim.class);
                intent.putExtra("uname", stn);
                intent.putExtra("value",st);
                intent.putExtra("gid",st1);
                intent.putExtra("SID",st3);
