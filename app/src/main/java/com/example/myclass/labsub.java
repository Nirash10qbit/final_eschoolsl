...
public class labsub extends AppCompatActivity {

    String said,st,st0,st1,st2,st3,st4,st5,st6,st16,st17,st18,st20,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,sbid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_labsub);
...
//
//                Intent intent = new Intent(labsub.this,labmarks.class);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url1, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(labsub.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
