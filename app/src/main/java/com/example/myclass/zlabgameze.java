...
public class zlabgameze extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabgameze);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(zlabgameze.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
    ...
    public void loadSession1(){
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://eschoolslgit1.000webhostapp.com/ce.php?gid="+st1+"&&sid="+st3+"&&cid="+st5+"&&ce="+ce+"";
    ...
    public void loadSession2(){
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://eschoolslgit1.000webhostapp.com/ne.php?gid="+st1+"&&sid="+st3+"&&cid="+st5+"";
    ...
    public void zaa(View view){
        Intent intent = new Intent(this,zlabgameae.class);
