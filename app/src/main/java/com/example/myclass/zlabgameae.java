...
public class zlabgameae extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabgameae);
    ...
    public void zbackza(View view){
        Intent intent = new Intent(this,gameze.class);
    ...
    public void loadSession1(){
        ...
        JsonObjectRequest jsonObjectRequest4 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/answer.php?cid="+st5+"", null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            tvaa.setText(response.getString("aae"));
        ...
        VolleySingleton.getInstance(zlabgameae.this).addToRequestQueue(jsonObjectRequest4);
    }
}