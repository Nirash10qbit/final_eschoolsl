...
public class gameza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gameza);
    ...
    public void loadSession1(){
        ...
        VolleySingleton.getInstance(gameza.this).addToRequestQueue(jsonObjectRequest4);
    }

    public void help(View view){
        Intent intent = new Intent(getApplicationContext(),zlabgameaa.class);
    ...
    public void nexta(View view){
        Intent intent = new Intent(getApplicationContext(),gamezb.class);
        intent.putExtra("uname", stn);
        intent.putExtra("language", stl);
        intent.putExtra("grade", stg);
        intent.putExtra("value", st);
