...
public class zlabnewmarks extends AppCompatActivity {

    String st,st0,st1,st2,st3,st4,st5,st6,st8,st9,st10,ca,cb,cc,cd,ce,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,totale,sttstn,sttmarks,stnt,totalt,markst,sttotal,
            stbstn,stbmarks,stbtotal,stzstn,stzmarks,stztotal,stnb,totalb,marksb,stnz,marksz,totalz,marks;
    TextView tva1,tva2,tva3,tva4,tva5,tva6,tva7,tva8,tva9,tva10,tvmarks;
    Button etadd,ethome;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zlabnewmarks);
    ...
    public void loadSession1(){
        ...
        VolleySingleton.getInstance(zlabnewmarks.this).addToRequestQueue(jsonObjectRequest)   ;
        ...
        VolleySingleton.getInstance(zlabnewmarks.this).addToRequestQueue(jsonObjectRequest2)   ;
        ...
        JsonObjectRequest jsonObjectRequest3 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/getlabact.php?aid="+sta+"&&bid="+stb+"&&zid="+stz+"", null,
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(zlabnewmarks.this,"wrong",Toast.LENGTH_SHORT).show();
                error.printStackTrace();
            }
        });


        VolleySingleton.getInstance(zlabnewmarks.this).addToRequestQueue(jsonObjectRequest3);
        ...
        VolleySingleton.getInstance(zlabnewmarks.this).addToRequestQueue(jsonObjectRequest4)   ;
        ...
        VolleySingleton.getInstance(zlabnewmarks.this).addToRequestQueue(jsonObjectRequest5);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Endspoint.updatedata_url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.equals("success")) {
                    ...
                    Toast.makeText(zlabnewmarks.this, " Successfully Access data", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(zlabnewmarks.this, gameza.class);
                    ...
                    Toast.makeText(zlabnewmarks.this, "Error", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(zlabnewmarks.this, gameza.class);
                    intent.putExtra("uname", stn);
                    intent.putExtra("language", stl);
                    intent.putExtra("grade", stg);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(zlabnewmarks.this, "Please check your Internet Connection", Toast.LENGTH_SHORT).show();
                Log.d("VOLLEY", error.getMessage());
                Intent intent = new Intent(zlabnewmarks.this, zlabnewmarks.class);
                intent.putExtra("uname", stn);
                intent.putExtra("language", stl);
                intent.putExtra("grade", stg);
                intent.putExtra("value", st);
