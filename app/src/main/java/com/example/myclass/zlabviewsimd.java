...
public class zlabviewsimd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabviewsimd);
        ...
        st30 = stqe + "?uname="+ stn +"&cid="+ st5 +"&fmarks=80";
    ...
    public void znexta(View view){
        Intent intent = new Intent(this,zlabnewload.class);
