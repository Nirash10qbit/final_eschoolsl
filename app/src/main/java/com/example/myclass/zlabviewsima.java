...
public class zlabviewsima extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabviewsima);
    ...
    public void znexta(View view){
        Intent intent = new Intent(this,zlabviewsimb.class);
