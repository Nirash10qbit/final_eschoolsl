...
public class zvlesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zvlesson);
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(),zvpage.class);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url1, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(zvlesson.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
