...
public class gamezd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamezd);
    ...
    public void loadSession1(){
        ...
        JsonObjectRequest jsonObjectRequest4 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/simmarks.php?uname="+stn+"&&cid="+st5+"", null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            tvanu.setText(response.getString("dnum"));
        ...
        VolleySingleton.getInstance(gamezd.this).addToRequestQueue(jsonObjectRequest4);
    }

    public void help(View view){
        Intent intent = new Intent(getApplicationContext(),zlabgamead.class);
    ...
    public void nexta(View view){
        Intent intent = new Intent(getApplicationContext(),gameze.class);
        intent.putExtra("uname", stn);
        intent.putExtra("language", stl);
        intent.putExtra("grade", stg);
        intent.putExtra("value", st);
