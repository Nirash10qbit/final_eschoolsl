...
public class zlabviewsim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zlabviewsim);
        ...
        st30 = stqa + "?fmarks="+stm+"&uname="+ stn +"&gid="+ st1+"&sid="+ st3+"&cid="+ st5;
    ...
    public void znexta(View view){
        Intent intent = new Intent(this,zlabviewsima.class);
        intent.putExtra("uname", stn);
        intent.putExtra("language", stl);
        intent.putExtra("grade", stg);
        intent.putExtra("value",st);
