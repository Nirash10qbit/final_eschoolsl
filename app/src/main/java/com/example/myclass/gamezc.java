...
public class gamezc extends AppCompatActivity {

    private String st,st0,st1,st2,st3,st4,st5,st6,st8,st9,st10,ca,cb,cc,cd,ce,stn,stl,stg,sta,stb,stz,stqa,stqb,stqc,stqd,stqe,staa,stab,stac,stad,stae,total,ra,rb,rc,rd,re,sac,saw,sanu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamezc);
    ...
    public void loadSession1(){
        ...
        JsonObjectRequest jsonObjectRequest4 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/simmarks.php?uname="+stn+"&&cid="+st5+"", null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            tvanu.setText(response.getString("cnum"));
        ...
        VolleySingleton.getInstance(gamezc.this).addToRequestQueue(jsonObjectRequest4);
    }

    public void help(View view){
        Intent intent = new Intent(getApplicationContext(),zlabgameac.class);
    ...
    public void nexta(View view){
        Intent intent = new Intent(getApplicationContext(),gamezd.class);
        intent.putExtra("uname", stn);
        intent.putExtra("language", stl);
        intent.putExtra("grade", stg);
        intent.putExtra("value", st);
