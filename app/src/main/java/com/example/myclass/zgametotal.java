...
public class zgametotal extends AppCompatActivity {

    String st,st0,st1,st2,st3,st4,st5,st6,st7,st8,st9,st10,st16,st17,st18,stn,stl,stg,ca,cb,cc,ra,rb,rc,totalc,uname,gid,sid,cid,cname,marks,ststn,stmarks,sttotal,stnt,markst,totalt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zgametotal);
        ...
        etanswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sttotal = tva13.getText().toString();


                int tot = Integer.valueOf(marks);

                int tnstn = Integer.valueOf(ststn);
                int nstn = tnstn + 1;
                stnt = String.valueOf(nstn);

                int tnmarks = Integer.valueOf(stmarks);
                ...
                addclasses(uname,gid,sid,cid,cname,marks,stnt,markst,totalt);


                Intent intent = new Intent(zgametotal.this,zanswers.class);
        ...
        ethome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(zgametotal.this,zlesson.class);
                intent.putExtra("uname", stn);
                intent.putExtra ("value", st);
                intent.putExtra("language", stl);
                intent.putExtra("grade", stg);
    ...
    public void loadSession1(){
        ...
        VolleySingleton.getInstance(zgametotal.this).addToRequestQueue(jsonObjectRequest6);

    }


    private void addclasses(final String uname, final String gid, final String sid, final String cid, final String cname,final String marks,final String stnt,final String markst,final String totalt) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Endspoint.addamarks_url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.equals("success")) {
                    ...
                    Toast.makeText(zgametotal.this, " Successfully Access data", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(zgametotal.this, "Please check your Internet Connection", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("ststn", stnt);
                params.put("stmarks", markst);
                params.put("sttotal", totalt);
