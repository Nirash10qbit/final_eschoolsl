...
public class gamezb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamezb);
    ...
    public void loadSession1(){
        ...
        JsonObjectRequest jsonObjectRequest4 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/simmarks.php?uname="+stn+"&&cid="+st5+"", null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            tvanu.setText(response.getString("bnum"));
        ...
        VolleySingleton.getInstance(gamezb.this).addToRequestQueue(jsonObjectRequest4);
    }

    public void help(View view){
        Intent intent = new Intent(getApplicationContext(),zlabgameab.class);
    ...
    public void nexta(View view){
        Intent intent = new Intent(getApplicationContext(),gamezc.class);
        intent.putExtra("uname", stn);
        intent.putExtra("language", stl);
        intent.putExtra("grade", stg);
        intent.putExtra("value", st);
